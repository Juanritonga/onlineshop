...
const DetailElectronics = () => {
  const { id } = useParams(); // Mengambil id produk dari URL
  const navigate = useNavigate();
  const [quantity, setQuantity] = useState(1); // State untuk jumlah produk
  const [paymentSuccess, setPaymentSuccess] = useState(false); // State untuk animasi pembayaran berhasil
  ...
  // Hitung total pembayaran berdasarkan jumlah produk
...
export default DetailElectronics;
